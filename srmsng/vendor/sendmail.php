...
$fm = "paladinnot@gmail.com"; // *** ต้องใช้อีเมล์ @gmail.com เท่านั้น ***
$to = "thanawat1petchuen@gmail.com"; // อีเมล์ที่ใช้รับข้อมูลจากแบบฟอร์ม
...
$mail->Username      = "paladinnot@gmail.com";  // Gmail Email username
$mail->Password       = 'To;y9oNgr=i=njo';            // Gmail Email password
/* ------------------------------------------------------------------------------------------------------------- */
