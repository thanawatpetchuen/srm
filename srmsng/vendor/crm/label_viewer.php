<? 
	...
	include("_libs/commons/UTF8_date_class.php");
	...
	*/
	...
	$_html = ($_html);
	//$_html = UTF8ToEntities($_html);
		
	$content = '<page style="font-family: freeserif;font-size:18px;">'.$_html.'</page>';
	//$content = $_html;
	//echo $content;
	//exit;
	...
	try{
		$html2pdf = new HTML2PDF('P','A4','th', true, 'UTF-8');
