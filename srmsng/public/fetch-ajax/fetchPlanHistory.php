...
$table = "srm_request, asset_tracker, location, material_master_record, fse, root_cause, correction, job_fse 
        ...
        FROM (SELECT service_request.service_request_id,service_request.title, service_request.status,
                ...
                service_request.due_date, service_asset.sng_code, service_asset.job_type, service_request.request_time  
