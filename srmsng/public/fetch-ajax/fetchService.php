...
$table = "(SELECT service_request.service_request_id,
        ...
        AND asset_tracker.location_code = location.location_code) AS sub_q GROUP BY sub_q.service_request_id";
...
$columns = array(
    ...
    array( 'db' => 'soi', 'dt' => 13 ),
    array( 'db' => 'road', 'dt' => 14 ),
    array( 'db' => 'sub_district', 'dt' => 15 ),
    array( 'db' => 'district', 'dt' => 16 ),
    array( 'db' => 'province', 'dt' => 17 ),
    array( 'db' => 'postal_code', 'dt' => 18 ),
    array( 'db' => 'region', 'dt' => 19 ),
    array( 'db' => 'country', 'dt' => 20 ),
    array( 'db' => 'store_phone', 'dt' => 21 ),
    array( 'db' => 'due_date', 'dt' => 22 ),
);
