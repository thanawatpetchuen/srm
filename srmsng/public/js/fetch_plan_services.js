// Fetch details for maintenance plan
// at /plan/details?maintenance_plan_id=
...
function fetchTable() {
  ...
  $("#supertable").DataTable({
    ...
    columnDefs: [
      {
        // Link to view details of the service request in the maintenance plan
        targets: 0,
        data: function(row) {
          return [row[0]];
        },
      ...
      },
      {
        ...
        render: function(data) {
          return (
            "<a class='btn btn-primary' href='../service/update?service_request_id=" +
            data +
...
// Create a dropdown from data in the row
...
// Make the button to show the dropdown
