            ...
            try{
                ...
                if($result){
                    ...
                    if(json_encode($_SESSION) == "[]"){
                        ...
                        unset($_COOKIE);
                        error_log("NO SESSION USER"." has try to use superadmin", 0);
