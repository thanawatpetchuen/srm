...
<body>
    ...
    <main class="container">
        <div class="form-container">
            <form id="add-news-form" enctype="multipart/form-data" method="POST" action="/srmsng/public/announcement/news/api/addnotice">
                <h2>Add Notices<br/>&nbsp</h2>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" id="addNoticesBtn">Confirm</button>
